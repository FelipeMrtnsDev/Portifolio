      ...
      <div className="max-w-5xl w-full px-3">
        ...
        <div className="flex justify-between">
          ...
          <div>
            ...
            <div className="border-2 border-black dark:border-white rounded-xl flex h-36 drop-shadow-lg" style={{ background: `url('${background}') center/cover` }}>
              <div
                className="h-full w-full flex flex-col justify-center text-lg font-semibold pl-6 rounded-r-xl text-black"
              >
